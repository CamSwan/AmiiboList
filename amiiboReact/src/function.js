//var test = "null";
export async function getAmiibo() {
...
export async function getDetail() {
  ...
  for (charindex = 0; charindex <= data.amiibo.length-1; charindex++ ){
    //if charindex -1
    if (num-1 === charindex) {
      document.getElementById("info1").innerHTML = "<img src=\"" + data.amiibo[charindex].image + "\", width=\"80%\"/> <br/>" + data.amiibo[charindex].name + "<br/>" + data.amiibo[charindex].gameSeries + "<br/>" + data.amiibo[charindex].amiiboSeries + "<br/>" + data.amiibo[charindex].type;
      document.getElementById("loader1").style.visibility="hidden";
    }
    //if charindex selected
    if (num === charindex) {
      //alert(num);
      document.getElementById("info2").innerHTML = "<img src=\"" + data.amiibo[charindex].image + "\", width=\"80%\"/> <br/>" + data.amiibo[charindex].name + "<br/>" + data.amiibo[charindex].gameSeries + "<br/>" + data.amiibo[charindex].amiiboSeries + "<br/>" + data.amiibo[charindex].type;
      document.getElementById("loader2").style.visibility="hidden";
    }
    //if charindex +1
    if (num+1 === charindex) {
      document.getElementById("info3").innerHTML = "<img src=\"" + data.amiibo[charindex].image + "\", width=\"80%\"/> <br/>"  + data.amiibo[charindex].name + "<br/>" + data.amiibo[charindex].gameSeries + "<br/>" + data.amiibo[charindex].amiiboSeries + "<br/>" + data.amiibo[charindex].type;
